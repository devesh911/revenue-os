...
- `app/` — the shell and wiring: boot, providers, sign-in, the session and workspace gates, and
  the router. Nothing here renders page content; it mounts the chrome and hands off to a page.
