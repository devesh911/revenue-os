...
# task-loop — thin router (skills advise, docs rule — AGENTS.md)
...
Merge or approve anything · edit `docs/**`, `AGENTS.md`, or applied migrations (blocking doc bug ⇒ §13 mini-ADR via the doc-change skill) · touch `.env`/secrets · force-push · add a dependency without a T24 BOM row · mutate an active agent/workflow version.
