...
# doc-change — thin router (skills advise, docs rule — AGENTS.md)
...
## Never
Edit `docs/**` or `AGENTS.md` outside such a PR · renumber or reuse D/T/S/G ids (§0) · treat a lessons.md entry as law (lessons are findings; merged ADRs are decisions) · bundle unrelated code into a decision PR.
