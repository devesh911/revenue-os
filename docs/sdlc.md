...
| Channels guarded doorway — `voice.place`/`wa.send` guard-before-send, ports-injected (T5, packages/channels) | ✅ | (this PR) | GREEN 2aaf0bb; 7/7 (31 expect), env-free; moat invariant #4 (S8.2); type-only harness dep, no BOM change; wa.send vars-merge → T7 |
