...
| www editorial redesign — Anthropic-inspired paper/ink/clay system, animated demo call + lead flow + moat art, pause switch (WCAG 2.2.2), mobile menu, deep links, favicon/meta | ✅ | (this PR) | Devesh ask 2026-09-23; no new deps; tests re-pinned to new tokens + sentence-case copy, + a11y/motion/separation pins; www 117/0, typecheck 0, biome 0, rls 0; worker suites need a worktree `.env` (CI-owned) |
