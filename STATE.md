...
- (this PR) T2 — dnc(fail-closed) + per-channel windowed attempt-cap hooks + clock-aware quiet-hours (fail-open); defaultPipeline autonomy→dnc→quiet→cap (moat #4); 13/13 — 2026-07-25
