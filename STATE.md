...
- (this PR) task-42 — raw-fetch Anthropic (Claude) adapter behind LlmProvider (T3, harness talker layer); 11/11, no SDK/dep (T19), fake stays CI default, API-key wiring deferred — 2026-07-25
